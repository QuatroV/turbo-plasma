...
export const transform: Transform = (domNode) => {
  ...
  if (domNode.name === "pre" && domNode.attribs.class === "ql-syntax") {
    ...
    const handleExecute = () => {};
    return (
      <div className="relative mt-4 w-full rounded-b rounded-tr bg-gray-700 p-2 font-mono text-white before:absolute before:left-0 before:-top-4 before:rounded-t before:bg-gray-600 before:px-2 before:text-xs before:content-['Code_fragment']">
